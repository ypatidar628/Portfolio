                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1
                            ...
                            initial="hidden"
                            animate="visible"   
                            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl"><span className=""></span>Yogendra Patidar</motion.h1>
                        <motion.span
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <motion.img
                            ...
                            initial="hidden"
                            animate="visible"
                            src={profilePic} alt="Yogendra Patidar" className="w-100 h-auto rounded-2xl" />
                    </div>
                </div>
            </div>
        </div>
